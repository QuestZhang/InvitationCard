    ...
    t.e = function(e, n) {
        ...
        if (void 0 !== i[e]) i[e].push(n);
            ...
            o.src = t.p + "" + e + "." + ({
                ...
                0 : "cc4de6242a37035e44e4",
                1 : "f2ce294fbbfe8980b384",
                3 : "b6f522d628d5cfa85830",
                4 : "4d445d9edceca5e9967d",
                5 : "84f514d1e1bbeece335f",
                6 : "e5ee20c3e1963d395683"
            } [e] + ".js",
            r.appendChild(o)
        }
    },
        ...
        i = function() {
            ...
            },
            {
                ...
                value: function(e, t, n) {
                    ...
                    i = window.location.host.indexOf("maka.io") >= 0 ? "domain=maka.io;": "",
            ...
            },
            {
                ...
                value: function(e) {
                    for (var t = void 0,
                    n = document.cookie.split(";"), r = 0, i = n.length; i > r; r++) {
                        var o = n[r];
                    ...
                    function t(t) {
                        e.find(t).each(function() {
                            if ("none" === $(this).attr("fill") || "none" === $(this).attr("stroke")) $(this).attr("class", "noColor");
                                ...
                                var e = !1;
                                for (var t in n) if ($(this).attr("fill") === n[t] || $(this).attr("stroke") === n[t]) {
